...
\restrict 33Nusj6QbBJtSHMI1Qb11YcfFMUcISEwFYGNeC94S8ThbcIaBRNDyme5aKiQquU
...
--
-- Name: cart_line; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.cart_line OWNER TO postgres;

--
-- Name: sale_line; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.sale_line OWNER TO postgres;

--
-- Name: activate_membership(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.activate_membership(p_id uuid, p_rp_order text, p_rp_payment text) OWNER TO postgres;

--
-- Name: active_banners(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.active_banners() OWNER TO postgres;

--
-- Name: add_batch(uuid, uuid, text, date, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_batch(p_product uuid, p_farm uuid, p_batch_code text, p_source_date date, p_quantity numeric, p_notes text) OWNER TO postgres;

--
-- Name: add_farm(text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_farm(p_name text, p_location text, p_kind text, p_contact text, p_notes text) OWNER TO postgres;

--
-- Name: add_po_item(uuid, uuid, numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_po_item(p_po uuid, p_product uuid, p_qty numeric, p_unit_cost numeric) OWNER TO postgres;

--
-- Name: add_recipe_item(uuid, uuid, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_recipe_item(p_recipe uuid, p_product uuid, p_qty numeric) OWNER TO postgres;

--
-- Name: add_review(uuid, text, integer, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_review(p_product uuid, p_name text, p_rating integer, p_body text, p_contact text) OWNER TO postgres;

--
-- Name: add_to_order(text, public.cart_line[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_to_order(p_number text, p_lines public.cart_line[]) OWNER TO postgres;

--
-- Name: apply_markdown(uuid, numeric, date, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.apply_markdown(p_product uuid, p_price numeric, p_ends date, p_reason text) OWNER TO postgres;

--
-- Name: approve_return(uuid, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.approve_return(p_id uuid, p_refund_points numeric, p_note text) OWNER TO postgres;

--
-- Name: attach_order_location(uuid, double precision, double precision); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.attach_order_location(p_order_id uuid, p_lat double precision, p_lng double precision) OWNER TO postgres;

--
-- Name: auto_assign_deliveries(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.auto_assign_deliveries() OWNER TO postgres;

--
-- Name: auto_draft_reorder(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.auto_draft_reorder(p_lookback integer, p_horizon integer, p_lead integer) OWNER TO postgres;

--
-- Name: batches_for_product(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.batches_for_product(p_product uuid) OWNER TO postgres;

--
-- Name: bestseller_ids(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.bestseller_ids(p_limit integer) OWNER TO postgres;

--
-- Name: block_mutation(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.block_mutation() OWNER TO postgres;

--
-- Name: business_overview(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.business_overview() OWNER TO postgres;

--
-- Name: cancel_order(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: cancel_purchase_order(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cancel_purchase_order(p_po uuid) OWNER TO postgres;

--
-- Name: cancel_stale_unpaid_orders(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cancel_stale_unpaid_orders() OWNER TO postgres;

--
-- Name: cart_recommendations(uuid[], integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cart_recommendations(p_products uuid[], p_limit integer) OWNER TO postgres;

--
-- Name: catalogue_by_category(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.catalogue_by_category(p_slug text) OWNER TO postgres;

--
-- Name: catalogue_categories(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.catalogue_categories() OWNER TO postgres;

--
-- Name: catalogue_stock(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.catalogue_stock() OWNER TO postgres;

--
-- Name: check_category_depth(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: claim_delivery(uuid, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.claim_delivery(p_order_id uuid, p_take boolean) OWNER TO postgres;

--
-- Name: clear_cart(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.clear_cart() OWNER TO postgres;

--
-- Name: create_purchase_order(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_purchase_order(p_location uuid, p_supplier uuid, p_notes text) OWNER TO postgres;

--
-- Name: create_recipe(text, text, boolean, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_recipe(p_name text, p_cuisine text, p_is_diet boolean, p_servings integer, p_description text) OWNER TO postgres;

--
-- Name: create_support_ticket(text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_support_ticket(p_subject text, p_message text, p_order_number text) OWNER TO postgres;
...
--
-- Name: delete_push_subscription(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.delete_push_subscription(p_endpoint text) OWNER TO postgres;

--
-- Name: delivers_to(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.delivers_to(p_org uuid, p_pincode text) OWNER TO postgres;

--
-- Name: demand_insights(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.demand_insights() OWNER TO postgres;

--
-- Name: demand_series(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.demand_series(p_product uuid, p_days integer) OWNER TO postgres;

--
-- Name: enqueue_customer_notification(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.enqueue_customer_notification() OWNER TO postgres;

--
-- Name: expire_markdowns(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.expire_markdowns() OWNER TO postgres;

--
-- Name: expire_old_batches(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.expire_old_batches() OWNER TO postgres;

--
-- Name: expiring_batches(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.expiring_batches(p_days integer) OWNER TO postgres;

--
-- Name: financials_overview(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.financials_overview(p_days integer) OWNER TO postgres;

--
-- Name: frequently_bought_together(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.frequently_bought_together(p_product uuid, p_limit integer) OWNER TO postgres;

--
-- Name: get_admin_recipes(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_admin_recipes() OWNER TO postgres;

--
-- Name: get_batches(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_batches(p_limit integer) OWNER TO postgres;
...
--
-- Name: get_farms(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_farms() OWNER TO postgres;

--
-- Name: get_hamper(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_hamper(p_id uuid) OWNER TO postgres;

--
-- Name: get_hampers(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_hampers() OWNER TO postgres;
...
--
-- Name: get_order_receipt(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_order_receipt(p_number text, p_phone text) OWNER TO postgres;

--
-- Name: get_product_reviews(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_product_reviews(p_product uuid, p_limit integer) OWNER TO postgres;
...
ALTER FUNCTION public.get_purchase_order(p_po uuid) OWNER TO postgres;

--
-- Name: get_recipe(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_recipe(p_id uuid, p_servings integer) OWNER TO postgres;

--
-- Name: get_recipe_cuisines(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_recipe_cuisines() OWNER TO postgres;

--
-- Name: get_recipes(text, text, integer, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_recipes(p_cuisine text, p_diet text, p_servings integer, p_max_budget numeric) OWNER TO postgres;
...
--
-- Name: get_returns(boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_returns(p_all boolean) OWNER TO postgres;

--
-- Name: get_store_admin_settings(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_store_admin_settings() OWNER TO postgres;

--
-- Name: get_store_settings(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_store_settings() OWNER TO postgres;
...
--
-- Name: get_support_tickets(boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_support_tickets(p_all boolean) OWNER TO postgres;

--
-- Name: grant_personal_coupon(text, text, numeric, numeric, integer, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.grant_personal_coupon(p_phone text, p_kind text, p_value numeric, p_min numeric, p_days integer, p_max numeric) OWNER TO postgres;

--
-- Name: has_location(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.has_location(loc uuid) OWNER TO postgres;

--
-- Name: hash_card_uid(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.hash_card_uid(p_uid text) OWNER TO postgres;

--
-- Name: in_stock_products(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.in_stock_products(p_org uuid) OWNER TO postgres;

--
-- Name: instant_refund(uuid, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.instant_refund(p_order_id uuid, p_points numeric, p_reason text) OWNER TO postgres;

--
-- Name: is_org_owner(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.is_org_owner() OWNER TO postgres;

--
-- Name: is_storefront_org(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.is_storefront_org(p_org uuid) OWNER TO postgres;

--
-- Name: issue_gift_card(numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.issue_gift_card(p_value numeric) OWNER TO postgres;

--
-- Name: list_purchase_orders(text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.list_purchase_orders(p_status text, p_limit integer) OWNER TO postgres;

--
-- Name: list_suppliers(boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.list_suppliers(p_include_inactive boolean) OWNER TO postgres;

--
-- Name: list_wastage(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.list_wastage(p_days integer, p_limit integer) OWNER TO postgres;

--
-- Name: log_temperature(uuid, text, numeric, numeric, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.log_temperature(p_location uuid, p_area text, p_temp numeric, p_min numeric, p_max numeric, p_note text) OWNER TO postgres;

--
-- Name: log_wastage(uuid, uuid, numeric, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.log_wastage(p_location uuid, p_product uuid, p_qty numeric, p_reason text, p_note text) OWNER TO postgres;

--
-- Name: margin_by_product(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.margin_by_product(p_days integer DEFAULT 30) RETURNS jsonb
  ...
  from (
    ...
    where o.org_id = public.current_org_id()
      and o.status <> 'cancelled'
      and o.placed_at >= now() - make_interval(days => greatest(coalesce(p_days,30),1))
    group by p.id, p.name, p.sale_price, p.last_cost
...
ALTER FUNCTION public.margin_by_product(p_days integer) OWNER TO postgres;

--
-- Name: mark_order_paid(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.mark_order_paid(p_order_id uuid, p_razorpay_order text, p_razorpay_payment text) RETURNS void
    ...
    SET search_path TO 'public'
    AS $$
declare v_org uuid; v_o record; v_notify_email text; v_notify_phone text; v_items text; v_was record;
begin
  select * into v_o from public.orders where id = p_order_id;
  if v_o.id is null then raise exception 'Order not found.'; end if;
  v_org := v_o.org_id;

  -- Idempotent: a duplicate webhook/verify must not double-notify.
  ...
  -- Notify the shop now that the money is in (mirrors the COD path in place_order).
...
ALTER FUNCTION public.mark_order_paid(p_order_id uuid, p_razorpay_order text, p_razorpay_payment text) OWNER TO postgres;

--
-- Name: mark_po_ordered(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.mark_po_ordered(p_po uuid) OWNER TO postgres;

--
-- Name: my_checkout_prefill(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_checkout_prefill() OWNER TO postgres;

--
-- Name: my_coupons(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_coupons() OWNER TO postgres;

--
-- Name: my_membership(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_membership() OWNER TO postgres;

--
-- Name: my_orders(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_orders() OWNER TO postgres;

--
-- Name: my_reorder_products(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_reorder_products(p_limit integer) OWNER TO postgres;

--
-- Name: my_savings(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_savings() OWNER TO postgres;

--
-- Name: my_scratch_cards(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_scratch_cards() OWNER TO postgres;

--
-- Name: my_shift(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_shift() OWNER TO postgres;

--
-- Name: my_tier(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: my_wallet(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.my_wallet() OWNER TO postgres;
...
--
-- Name: notify_on_restock(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.notify_on_restock() OWNER TO postgres;

--
-- Name: one_default_address(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.one_default_address() OWNER TO postgres;

--
-- Name: payment_reconciliation(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.payment_reconciliation(p_days integer) OWNER TO postgres;

--
-- Name: personalized_products(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.personalized_products(p_limit integer) OWNER TO postgres;

--
-- Name: place_order(uuid, text, text, text, text, text, text, text, text, public.cart_line[], text, text, boolean, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.place_order(p_org_id uuid, p_contact_name text, p_contact_phone text, p_address_line text, p_city text, p_pincode text, p_landmark text, p_delivery_slot text, p_notes text, p_lines public.cart_line[], p_contact_email text, p_coupon_code text, p_use_credit boolean, p_payment_method text) OWNER TO postgres;

--
-- Name: pos_loyalty_lookup(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.pos_loyalty_lookup(p_code text) OWNER TO postgres;

--
-- Name: preview_coupon(uuid, text, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.preview_coupon(p_org uuid, p_code text, p_subtotal numeric, p_phone text) OWNER TO postgres;

--
-- Name: price_check(numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
  ...
  from (
    select p.name, p.sale_price, p.last_cost,
           case when p.sale_price > 0
                then round((p.sale_price - p.last_cost)/p.sale_price*100,1)
...
ALTER FUNCTION public.price_check(p_threshold numeric) OWNER TO postgres;

--
-- Name: procurement_overview(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.procurement_overview() OWNER TO postgres;

--
-- Name: product_department(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.product_department(p_product uuid) OWNER TO postgres;

--
-- Name: product_ratings(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.product_ratings() OWNER TO postgres;

--
-- Name: rate_delivery(text, text, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.rate_delivery(p_number text, p_phone text, p_rating integer, p_comment text) OWNER TO postgres;

--
-- Name: recalc_sale_payment(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.recalc_sale_payment() OWNER TO postgres;

--
-- Name: recall_trace(uuid, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.recall_trace(p_product uuid, p_from date, p_to date) OWNER TO postgres;
...
begin
  ...
  select status, location_id, supplier_id, po_number
    ...
    from public.purchase_orders where id = p_po and org_id = v_org;
  if v_status is null then raise exception 'Purchase order not found.'; end if;
...
ALTER FUNCTION public.receive_purchase_order(p_po uuid, p_items jsonb) OWNER TO postgres;

--
-- Name: recent_temperature(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.recent_temperature(p_days integer, p_limit integer) OWNER TO postgres;

--
-- Name: record_account_payment(uuid, numeric, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.record_account_payment(p_customer_id uuid, p_amount numeric, p_method text, p_note text) OWNER TO postgres;

--
-- Name: record_production(uuid, uuid, numeric, date, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.record_production(p_location uuid, p_product uuid, p_qty numeric, p_expiry date, p_note text) OWNER TO postgres;

--
-- Name: record_sale(uuid, uuid, public.sale_line[], text, numeric, text, uuid, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.record_sale(p_location uuid, p_customer_id uuid, p_lines public.sale_line[], p_method text, p_amount_paid numeric, p_note text, p_loyalty_user uuid, p_points_redeem numeric) OWNER TO postgres;

--
-- Name: record_stock(uuid, uuid, numeric, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.record_stock(p_location uuid, p_product uuid, p_delta numeric, p_reason text, p_note text) OWNER TO postgres;

--
-- Name: redeem_gift_card(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.redeem_gift_card(p_code text) RETURNS jsonb
    ...
    SET search_path TO 'public'
    AS $$
declare v_uid uuid; v_org uuid; c record;
begin
  v_uid := auth.uid();
  if v_uid is null then return jsonb_build_object('ok', false, 'message', 'Please sign in.'); end if;
  select public.storefront_org_id() into v_org;
  ...
  if c.redeemed_at is not null then return jsonb_build_object('ok', false, 'message', 'This gift card has already been used.'); end if;

  update public.gift_cards set redeemed_by = v_uid, redeemed_at = now() where id = c.id;
  insert into public.wallet_ledger (org_id, user_id, amount, reason, ref)
  values (v_org, v_uid, c.value, 'gift', c.code);
  return jsonb_build_object('ok', true, 'value', c.value);
end $$;


ALTER FUNCTION public.redeem_gift_card(p_code text) OWNER TO postgres;

--
-- Name: redeem_referral(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
begin
  ...
  update public.referrals set referred_by = v_owner where user_id = v_uid;
  insert into public.wallet_ledger (org_id, user_id, amount, reason, ref)
...
--
-- Name: refill_suggestions(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.refill_suggestions() OWNER TO postgres;

--
-- Name: reject_return(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.reject_return(p_id uuid, p_note text) OWNER TO postgres;

--
-- Name: remind_abandoned_carts(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.remind_abandoned_carts() OWNER TO postgres;

--
-- Name: remove_po_item(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.remove_po_item(p_item uuid) OWNER TO postgres;

--
-- Name: reorder_suggestions(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.reorder_suggestions(p_lookback integer, p_horizon integer, p_lead integer) OWNER TO postgres;

--
-- Name: request_return(text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.request_return(p_number text, p_reason text, p_phone text) OWNER TO postgres;

--
-- Name: resolve_card(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.resolve_card(p_uid text) OWNER TO postgres;

--
-- Name: resolve_support_ticket(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.resolve_support_ticket(p_id uuid, p_reply text) OWNER TO postgres;

--
-- Name: retire_product(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.retire_product(p_id uuid, p_reason text) OWNER TO postgres;

--
-- Name: reveal_scratch_card(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.reveal_scratch_card(p_id uuid) RETURNS integer
    ...
    SET search_path TO 'public'
    AS $$
declare v_uid uuid; c record;
begin
  v_uid := auth.uid();
  if v_uid is null then raise exception 'Please sign in.'; end if;
  select * into c from public.scratch_cards where id = p_id and user_id = v_uid;
  if c.id is null then raise exception 'Card not found.'; end if;
  if c.revealed_at is not null then return c.reward_points; end if;

  update public.scratch_cards set revealed_at = now() where id = p_id;
  insert into public.wallet_ledger (org_id, user_id, amount, reason, ref)
  values (c.org_id, v_uid, c.reward_points, 'reward', 'SCRATCH:' || c.id::text);
  return c.reward_points;
end $$;


ALTER FUNCTION public.reveal_scratch_card(p_id uuid) OWNER TO postgres;

--
-- Name: revert_markdown(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.revert_markdown(p_product uuid) OWNER TO postgres;

--
-- Name: reward_on_delivery(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.reward_on_delivery() OWNER TO postgres;
...
--
-- Name: run_due_subscriptions(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.run_due_subscriptions() OWNER TO postgres;

--
-- Name: run_one_subscription(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.run_one_subscription(p_sub uuid) OWNER TO postgres;

--
-- Name: run_winback(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.run_winback(p_days integer) OWNER TO postgres;

--
-- Name: sales_by_payment(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.sales_by_payment(p_days integer) OWNER TO postgres;

--
-- Name: sales_summary(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.sales_summary() OWNER TO postgres;

--
-- Name: save_cart(integer, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.save_cart(p_item_count integer, p_subtotal numeric) OWNER TO postgres;

--
-- Name: save_product(uuid, text, uuid, uuid, numeric, numeric, text, numeric, text, text, text, boolean, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.save_product(p_id uuid, p_name text, p_category_id uuid, p_brand_id uuid, p_sale_price numeric, p_compare_at_price numeric, p_description text, p_pack_size numeric, p_pack_unit text, p_badge text, p_image_path text, p_is_published boolean, p_sort_order integer) OWNER TO postgres;

--
-- Name: save_push_subscription(text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: served_areas(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.served_areas() OWNER TO postgres;

--
-- Name: set_member_owner(uuid, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_member_owner(p_user uuid, p_is_owner boolean) OWNER TO postgres;

--
-- Name: set_my_shift(boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_my_shift(p_on boolean) OWNER TO postgres;

--
-- Name: set_recipe_image(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_recipe_image(p_recipe uuid, p_path text) OWNER TO postgres;

--
-- Name: set_recipe_video(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_recipe_video(p_recipe uuid, p_url text) OWNER TO postgres;

--
-- Name: set_supplier_active(uuid, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_supplier_active(p_id uuid, p_active boolean) OWNER TO postgres;
...
--
-- Name: settle_razorpay_payment(text, text, integer, text, jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.settle_razorpay_payment(p_payment_id text, p_rp_order text, p_amount integer, p_event text, p_raw jsonb) OWNER TO postgres;
...
--
-- Name: start_membership(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.start_membership(p_plan uuid) OWNER TO postgres;

--
-- Name: stock_available(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.stock_available(p_location uuid, p_product uuid) OWNER TO postgres;

--
-- Name: storefront_org_id(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.storefront_org_id() OWNER TO postgres;

--
-- Name: subscription_discount_pct(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.subscription_discount_pct() OWNER TO postgres;

--
-- Name: tip_delivery(text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
begin
  ...
  if public.wallet_balance(v_uid) < p_points then return jsonb_build_object('ok', false, 'message', 'Not enough points for that tip.'); end if;
...
ALTER FUNCTION public.tip_delivery(p_number text, p_points integer) OWNER TO postgres;

--
-- Name: track_order(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.track_order(p_number text, p_phone text) OWNER TO postgres;

--
-- Name: trg_stock_batch(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trg_stock_batch() OWNER TO postgres;

--
-- Name: unit_price(numeric, numeric, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.unit_price(p_sale numeric, p_size numeric, p_unit text) OWNER TO postgres;

--
-- Name: update_rider_location(uuid, double precision, double precision, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_rider_location(p_order_id uuid, p_lat double precision, p_lng double precision, p_eta integer) OWNER TO postgres;

--
-- Name: update_store_settings(text, text, text, text, text, numeric, numeric, text, text, numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_store_settings(p_name text, p_support_email text, p_support_phone text, p_notify_email text, p_notify_phone text, p_free_delivery_threshold numeric, p_delivery_fee numeric, p_gstin text, p_business_address text, p_max_discount_percent numeric, p_subscription_discount_percent numeric) OWNER TO postgres;

--
-- Name: upsert_customer(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.upsert_customer(p_location uuid, p_name text, p_phone text) OWNER TO postgres;

--
-- Name: upsert_supplier(uuid, text, text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.upsert_supplier(p_id uuid, p_name text, p_contact text, p_phone text, p_email text, p_address text, p_notes text) OWNER TO postgres;

--
-- Name: wallet_balance(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.wallet_balance(p_user uuid) RETURNS numeric
  ...
  from public.wallet_ledger where user_id = p_user;
$$;


ALTER FUNCTION public.wallet_balance(p_user uuid) OWNER TO postgres;

--
-- Name: wastage_summary(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.wastage_summary(p_days integer) OWNER TO postgres;

--
-- Name: watch_stock(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.watch_stock(p_product uuid, p_email text, p_phone text) OWNER TO postgres;

--
-- Name: write_off_batch(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.write_off_batch(p_batch uuid, p_reason text, p_note text) OWNER TO postgres;
...
--
-- Name: batch_code_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.category_affinity OWNER TO postgres;
...
--
-- Name: cold_chain_logs; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: hamper_items; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.hamper_items OWNER TO postgres;

--
-- Name: hampers; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: location_daily_sales; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.location_daily_sales OWNER TO postgres;
...
--
-- Name: markdowns; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.markdowns OWNER TO postgres;
...
CREATE TABLE public.notifications (
    ...
    CONSTRAINT notifications_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'sent'::text, 'failed'::text, 'skipped'::text])))
);
...
--
-- Name: open_shifts; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.open_shifts OWNER TO postgres;
...
--
-- Name: order_queue; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.order_queue OWNER TO postgres;
...
--
-- Name: pass_memberships; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.pass_memberships OWNER TO postgres;
...
--
-- Name: saved_carts; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: scratch_cards; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.scratch_cards OWNER TO postgres;

--
-- Name: staff_cards; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.staff_cards OWNER TO postgres;
...
--
-- Name: wastage_log; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.wastage_log OWNER TO postgres;

--
-- Name: winback_log; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.winback_log OWNER TO postgres;
...
--
-- Name: brands brands_org_id_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: categories categories_org_id_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity category_affinity_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cold_chain_logs cold_chain_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: coupons coupons_org_id_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: delivery_zones delivery_zones_org_id_pincode_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hamper_items hamper_items_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hampers hampers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns markdowns_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memberships memberships_user_id_location_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_org_id_order_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pass_memberships pass_memberships_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payment_events payment_events_razorpay_payment_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews reviews_product_id_contact_hash_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: saved_carts saved_carts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: scratch_cards scratch_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards staff_cards_org_id_card_uid_hash_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards staff_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stations stations_org_id_location_id_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log wastage_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: winback_log winback_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_addr_user; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_batch_lookup; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_brands_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_cards_active; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_cards_staff; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_categories_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_coldchain_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customers_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_events_entity; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_events_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_memberships_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_orders_assigned; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_orders_org_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_orders_phone_recent; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_pass_user; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_payments_customer; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_payments_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_po_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_profiles_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_returns_org_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sales_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_scratch_pending; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_shifts_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_shifts_staff; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_staff_active; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_staff_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stations_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_alert_pending; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_org_loc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stockmov_batch; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stockmov_created; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stockmov_lookup; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stockmov_ref; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_subs_due; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_support_org_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_wastage_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_zones_org; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_markdown_active; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_one_primary_brand; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_org_slug; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_products_slug; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_shift_one_open; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: order_queue _RETURN; Type: RULE; Schema: public; Owner: postgres
--
...
--
-- Name: brands trg_brands_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: categories trg_category_depth; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: events trg_events_no_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_movements trg_notify_on_restock; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: customer_addresses trg_one_default_address; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: orders trg_order_customer_notify; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: orders trg_order_rewards; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: payments trg_payment_recalc; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sales trg_sales_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: shifts trg_shifts_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: staff_members trg_staff_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stations trg_stations_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_movements trg_stock_batch; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items trg_stock_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_movements trg_stockmov_no_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: banners banners_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: brands brands_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: categories categories_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity category_affinity_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cold_chain_logs cold_chain_logs_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cold_chain_logs cold_chain_logs_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cold_chain_logs cold_chain_logs_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: coupons coupons_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: delivery_zones delivery_zones_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: farms farms_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: gift_cards gift_cards_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hamper_items hamper_items_hamper_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hamper_items hamper_items_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hampers hampers_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns markdowns_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns markdowns_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns markdowns_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: membership_plans membership_plans_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memberships memberships_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: organizations organizations_storefront_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pass_memberships pass_memberships_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pass_memberships pass_memberships_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pass_memberships pass_memberships_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payments payments_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_batches product_batches_farm_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_batches product_batches_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_batches product_batches_po_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_order_items purchase_order_items_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_orders purchase_orders_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipe_items recipe_items_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: returns returns_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews reviews_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sales sales_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: saved_carts saved_carts_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: saved_carts saved_carts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: scratch_cards scratch_cards_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: scratch_cards scratch_cards_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: shifts shifts_staff_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards staff_cards_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards staff_cards_staff_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_members staff_members_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_members staff_members_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stations stations_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stations stations_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_alerts stock_alerts_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items stock_items_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items stock_items_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wallet_ledger wallet_ledger_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log wastage_log_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log wastage_log_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log wastage_log_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log wastage_log_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_addresses addr_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_addresses addr_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity affinity_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity affinity_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: banners banner_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: banners banner_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: product_batches batches_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: brands brand_owner_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: brands brand_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: brands brand_staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards cards_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: saved_carts cart_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: categories cat_owner_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: categories cat_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: categories cat_staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: category_affinity; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: cities cities_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: cold_chain_logs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.cold_chain_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: cold_chain_logs coldchain_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: coupons coupon_owner_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customers cust_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customers cust_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customers cust_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customers cust_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: events evt_insert; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: events evt_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: farms farms_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: gift_cards; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.gift_cards ENABLE ROW LEVEL SECURITY;

--
-- Name: hamper_items; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.hamper_items ENABLE ROW LEVEL SECURITY;

--
-- Name: hampers; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.hampers ENABLE ROW LEVEL SECURITY;

--
-- Name: hampers hampers_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: locations loc_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: locations loc_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns markdown_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: markdowns; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.markdowns ENABLE ROW LEVEL SECURITY;

--
-- Name: memberships mem_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: memberships mem_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: memberships membership_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: notifications notif_staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: order_items order_items_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: organizations org_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: organizations org_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pass_memberships; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.pass_memberships ENABLE ROW LEVEL SECURITY;

--
-- Name: pass_memberships pass_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: payments pay_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: payments pay_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: payments pay_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: membership_plans plans_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_orders po_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_order_items poi_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products prod_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products prod_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products prod_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products prod_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products prod_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: product_batches; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles prof_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles prof_update_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: recipe_items; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: recipes recipes_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: referrals referral_read_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: returns returns_customer_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: returns returns_staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews review_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews review_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sales sale_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sales sale_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sales sale_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sales sale_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: saved_carts; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.saved_carts ENABLE ROW LEVEL SECURITY;

--
-- Name: scratch_cards; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.scratch_cards ENABLE ROW LEVEL SECURITY;

--
-- Name: scratch_cards scratch_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: shifts shifts_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_items si_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_items si_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_cards; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_members staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_members staff_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: states states_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stations stations_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stations stations_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_alerts stock_alert_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_alerts; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.stock_alerts ENABLE ROW LEVEL SECURITY;

--
-- Name: stock_items stock_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items stock_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items stock_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_items stock_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_movements stockmov_insert; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_movements stockmov_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: subscriptions sub_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: support_tickets support_customer; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: support_tickets support_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: wallet_ledger; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.wallet_ledger ENABLE ROW LEVEL SECURITY;

--
-- Name: wallet_ledger wallet_read_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: wastage_log; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.wastage_log ENABLE ROW LEVEL SECURITY;

--
-- Name: wastage_log wastage_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: winback_log; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.winback_log ENABLE ROW LEVEL SECURITY;

--
-- Name: delivery_zones zone_owner_write; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: delivery_zones zone_public_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: delivery_zones zone_staff_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION activate_membership(p_id uuid, p_rp_order text, p_rp_payment text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION active_banners(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_batch(p_product uuid, p_farm uuid, p_batch_code text, p_source_date date, p_quantity numeric, p_notes text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_farm(p_name text, p_location text, p_kind text, p_contact text, p_notes text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_po_item(p_po uuid, p_product uuid, p_qty numeric, p_unit_cost numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_recipe_item(p_recipe uuid, p_product uuid, p_qty numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_review(p_product uuid, p_name text, p_rating integer, p_body text, p_contact text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_to_order(p_number text, p_lines public.cart_line[]); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION apply_markdown(p_product uuid, p_price numeric, p_ends date, p_reason text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION approve_return(p_id uuid, p_refund_points numeric, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION attach_order_location(p_order_id uuid, p_lat double precision, p_lng double precision); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION auto_assign_deliveries(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION auto_draft_reorder(p_lookback integer, p_horizon integer, p_lead integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION batches_for_product(p_product uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION bestseller_ids(p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION block_mutation(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION business_overview(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION cancel_order(p_order_id uuid, p_reason text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION cancel_purchase_order(p_po uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION cancel_stale_unpaid_orders(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION cart_recommendations(p_products uuid[], p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION catalogue_by_category(p_slug text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION catalogue_categories(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION catalogue_stock(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION check_category_depth(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION claim_delivery(p_order_id uuid, p_take boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION clear_cart(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION create_purchase_order(p_location uuid, p_supplier uuid, p_notes text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION create_recipe(p_name text, p_cuisine text, p_is_diet boolean, p_servings integer, p_description text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION create_support_ticket(p_subject text, p_message text, p_order_number text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION delete_push_subscription(p_endpoint text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION delivers_to(p_org uuid, p_pincode text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION demand_insights(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION demand_series(p_product uuid, p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION enqueue_customer_notification(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION expire_markdowns(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION expire_old_batches(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION expiring_batches(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION financials_overview(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION frequently_bought_together(p_product uuid, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_admin_recipes(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_batches(p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_farms(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_hamper(p_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_hampers(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_order_receipt(p_number text, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_product_reviews(p_product uuid, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_purchase_order(p_po uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_recipe(p_id uuid, p_servings integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_recipe_cuisines(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_recipes(p_cuisine text, p_diet text, p_servings integer, p_max_budget numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_returns(p_all boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_store_admin_settings(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_store_settings(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_support_tickets(p_all boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION grant_personal_coupon(p_phone text, p_kind text, p_value numeric, p_min numeric, p_days integer, p_max numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION has_location(loc uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION hash_card_uid(p_uid text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION in_stock_products(p_org uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION instant_refund(p_order_id uuid, p_points numeric, p_reason text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_org_owner(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_storefront_org(p_org uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION issue_gift_card(p_value numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION list_purchase_orders(p_status text, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION list_suppliers(p_include_inactive boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION list_wastage(p_days integer, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION log_temperature(p_location uuid, p_area text, p_temp numeric, p_min numeric, p_max numeric, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION log_wastage(p_location uuid, p_product uuid, p_qty numeric, p_reason text, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION margin_by_product(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION mark_order_paid(p_order_id uuid, p_razorpay_order text, p_razorpay_payment text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION mark_po_ordered(p_po uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_checkout_prefill(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_coupons(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_membership(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_orders(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_reorder_products(p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_savings(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_scratch_cards(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_shift(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_tier(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION my_wallet(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION next_order_number(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION notify_on_restock(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION one_default_address(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION payment_reconciliation(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION personalized_products(p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION place_order(p_org_id uuid, p_contact_name text, p_contact_phone text, p_address_line text, p_city text, p_pincode text, p_landmark text, p_delivery_slot text, p_notes text, p_lines public.cart_line[], p_contact_email text, p_coupon_code text, p_use_credit boolean, p_payment_method text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION pos_loyalty_lookup(p_code text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION preview_coupon(p_org uuid, p_code text, p_subtotal numeric, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION price_check(p_threshold numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION procurement_overview(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION product_department(p_product uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION product_ratings(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION rate_delivery(p_number text, p_phone text, p_rating integer, p_comment text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION recalc_sale_payment(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION recall_trace(p_product uuid, p_from date, p_to date); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION receive_purchase_order(p_po uuid, p_items jsonb); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION recent_temperature(p_days integer, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION record_account_payment(p_customer_id uuid, p_amount numeric, p_method text, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION record_production(p_location uuid, p_product uuid, p_qty numeric, p_expiry date, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION record_sale(p_location uuid, p_customer_id uuid, p_lines public.sale_line[], p_method text, p_amount_paid numeric, p_note text, p_loyalty_user uuid, p_points_redeem numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION record_stock(p_location uuid, p_product uuid, p_delta numeric, p_reason text, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION redeem_gift_card(p_code text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION redeem_referral(p_code text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION refill_suggestions(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reject_return(p_id uuid, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION remind_abandoned_carts(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION remove_po_item(p_item uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reorder_suggestions(p_lookback integer, p_horizon integer, p_lead integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION request_return(p_number text, p_reason text, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION resolve_card(p_uid text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION resolve_support_ticket(p_id uuid, p_reply text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION retire_product(p_id uuid, p_reason text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reveal_scratch_card(p_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION revert_markdown(p_product uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reward_on_delivery(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION run_due_subscriptions(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION run_one_subscription(p_sub uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION run_winback(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION sales_by_payment(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION sales_summary(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION save_cart(p_item_count integer, p_subtotal numeric); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION save_product(p_id uuid, p_name text, p_category_id uuid, p_brand_id uuid, p_sale_price numeric, p_compare_at_price numeric, p_description text, p_pack_size numeric, p_pack_unit text, p_badge text, p_image_path text, p_is_published boolean, p_sort_order integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION save_push_subscription(p_endpoint text, p_p256dh text, p_auth text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION served_areas(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_member_owner(p_user uuid, p_is_owner boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_my_shift(p_on boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_recipe_image(p_recipe uuid, p_path text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_recipe_video(p_recipe uuid, p_url text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_supplier_active(p_id uuid, p_active boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION settle_razorpay_payment(p_payment_id text, p_rp_order text, p_amount integer, p_event text, p_raw jsonb); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION slugify(p_text text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION start_membership(p_plan uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION stock_available(p_location uuid, p_product uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION storefront_org_id(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION subscription_discount_pct(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION tip_delivery(p_number text, p_points integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION track_order(p_number text, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION trg_stock_batch(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION unit_price(p_sale numeric, p_size numeric, p_unit text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_rider_location(p_order_id uuid, p_lat double precision, p_lng double precision, p_eta integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION upsert_customer(p_location uuid, p_name text, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION upsert_supplier(p_id uuid, p_name text, p_contact text, p_phone text, p_email text, p_address text, p_notes text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION wallet_balance(p_user uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION wastage_summary(p_days integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION watch_stock(p_product uuid, p_email text, p_phone text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION write_off_batch(p_batch uuid, p_reason text, p_note text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE batch_code_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE category_affinity; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE cold_chain_logs; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE hamper_items; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE location_daily_sales; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE markdowns; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE open_shifts; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE order_queue; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN orders.confirmed_at; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN orders.delivered_at; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN orders.updated_at; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE pass_memberships; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE saved_carts; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE scratch_cards; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE staff_cards; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE stock_on_hand; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE wallet_ledger; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE wallet_ledger_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE wastage_log; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE winback_log; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict 33Nusj6QbBJtSHMI1Qb11YcfFMUcISEwFYGNeC94S8ThbcIaBRNDyme5aKiQquU
