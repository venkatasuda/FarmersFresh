...
export function CartButton() {
  ...
  return (
    <Link
      href="/cart"
      className="relative flex items-center gap-2 rounded-lg bg-brand-600 px-3.5 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-700"
    >
      ...
      <span>Basket</span>
      {/* Render the count only after hydration — the server cannot know what
          is in localStorage, and rendering 0 then 3 is a hydration mismatch. */}
      {ready && count > 0 ? (
